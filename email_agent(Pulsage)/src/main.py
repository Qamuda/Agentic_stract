...
# === CONFIG ===
THUNDERBIRD_INBOX = os.path.expanduser("Your_email_location")
...
OLLAMA_URL = "http://localhost:11434/api/generate"  ## Probably need to download Ollama
MODEL = "gemma3:1b" ## Could use a stronger version, based on computer spces
DAYS_BACK = 3
